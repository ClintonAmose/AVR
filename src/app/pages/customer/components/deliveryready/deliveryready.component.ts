...
import { DeliveryreadyService } from './deliveryready.service';
...
@Component({
  selector: 'app-deliveryready',
  templateUrl: './deliveryready.component.html',
  styleUrls: ['./deliveryready.component.css','../../../tables/components/dataTables/dataTables.scss']
})
export class DeliveryreadyComponent implements OnInit {
   ...
   public myDatePickerOptions: IMyDpOptions = {
    ...
    constructor(private location: Location, private service: DeliveryreadyService, private commonservice: CommonService ) { 
		//Get User rights
