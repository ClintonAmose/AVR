...
@Component({
  ...
  templateUrl: './overdueorders.component.html',
  styleUrls: ['./overdueorders.component.css','../../../tables/components/dataTables/dataTables.scss']
})
export class OverdueordersComponent implements OnInit {
   ...
   public myDatePickerOptions: IMyDpOptions = {
    ...
    constructor(private location: Location,completerService: CompleterService,http: Http,private route: ActivatedRoute, private router: Router, private service: OverdueordersService, private commonservice: CommonService,private excelService: ExcelService  ) { 
		//Get User rights
