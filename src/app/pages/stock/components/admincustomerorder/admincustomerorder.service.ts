...
@Injectable()
export class AdminCustomerorderService {
	...
	getAdmin_orders(order_fliter): any {
        return this.http
            .post( BaseAPIURL + 'Customer_api/customer_admin_orders',order_fliter, this.commonService.getHeader() )
            .map(( response ) => {
                // some response manipulation
                let result = response.json();
                return result.responseData;
	...
	remove_orderimage(order_images) :any {
		 return this.http
            .post( BaseAPIURL + 'Customer_api/reomove_ordersimages',order_images, this.commonService.getHeader() )
            .map(( response ) => {
                // some response manipulation
                let result = response.json();
                return result;
	 ...
	 updateadminorder( orderdata ): any {

        return this.http
            .post( BaseAPIURL + 'Customer_api/update_customer_order', orderdata, this.commonService.getHeader() )
            .map(( response ) => {
                // some response manipulation
                let result = response.json();
                return result;
	...
	saveadminbulkorder( orderdata ): any {

        return this.http
            .post( BaseAPIURL + 'Customer_api/create_customer_bulkorder', orderdata, this.commonService.getHeader() )
            .map(( response ) => {
                // some response manipulation
                let result = response.json();
                return result;
